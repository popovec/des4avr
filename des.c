/*
    ...
    RAM usage, minimal FLASH usage (on 8 bit AVR below 1300 bytes, speed
    about 177300 instruction for DES encrypt/decrypt). Please check des.S
    AVR implementation of this code).
...
#ifdef KEY_PERMUTATION
  permute (8, initial_key_permutation, main_key, key);
#else
